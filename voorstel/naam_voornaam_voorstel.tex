...
\Authors{Milan Dima\textsuperscript{1}} % Authors
\CoPromotor{Daniel Du Seuil ???\textsuperscript{2} (Bedrijfsnaam)}
\affiliation{\textbf{Contact:}
  \textsuperscript{1} \href{mailto:milan.dima.w3031@student.hogent.be}{milan.dima.w3031@student.hogent.be};
